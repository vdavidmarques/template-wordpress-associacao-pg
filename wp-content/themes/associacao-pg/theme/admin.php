...
/*******************************
    ...
    ********************************/
        ...
        *Create a page called "General Information", then change the ID at lines 23        ********************************/

        add_action('admin_menu', 'linked_url');
        function linked_url() {
            add_menu_page('linked_url','Informações Gerais','read','post.php?post=21&action=edit','', 'dashicons-admin-generic',  90);
        }
